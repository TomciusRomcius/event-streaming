...
static IProperty* ParseProperty(const nlohmann::json& propValue, PropertyType propType)
{
...
CreateEventTypeHandler::CreateEventTypeHandler(EventSystem& eventSystem) : m_EventSystem(eventSystem) {}

void CreateEventTypeHandler::Execute(TcpRequest request)
{
...
ProduceEventHandler::ProduceEventHandler(EventSystem& eventSystem) : m_EventSystem(eventSystem) {}

void ProduceEventHandler::Execute(TcpRequest request)
{
...
SubscribeToEventHandler::SubscribeToEventHandler(EventSystem& eventSystem) : m_EventSystem(eventSystem) {}

void SubscribeToEventHandler::Execute(TcpRequest request)
{
    nlohmann::json json = request.body;
...
UnsubscribeFromEventHandler::UnsubscribeFromEventHandler(EventSystem& eventSystem) : m_EventSystem(eventSystem) {}

void UnsubscribeFromEventHandler::Execute(TcpRequest request)
{
